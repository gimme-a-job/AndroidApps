package com.example.mydroid4_1;
...
//        dispBtn1.setOnClickListener(new ButtonClickListener());
        dispBtn1.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View view) {
                                            String btn_name = getString(R.string.btn_title1); //"http://9ensan.com/blog/smartphone/android/android-strings-xml-getstring/"
...
//        dispBtn2.setOnClickListener(this);
        dispBtn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String btn_name = getString(R.string.btn_title2); //"http://9ensan.com/blog/smartphone/android/android-strings-xml-getstring/"
                Toast.makeText(getApplicationContext(), btn_name + "が押されました", Toast.LENGTH_SHORT).show();
            }
        });
    }
